...
def page_shell(title: str, content_html: str, base_path: str, canonical_href: str | None = None) -> str:
    ...
    rss_href = "https://bobbyllm.codeberg.page/llama-conductor/feed.xml"
...
{canonical_line}  <meta name="robots" content="index,follow">
  <link rel="alternate" type="application/rss+xml" title="llama-conductor RSS" href="{rss_href}">
...
def build_site(
    ...
    if feed_xml.exists():
        shutil.copy2(feed_xml, out_root / "feed.xml")
