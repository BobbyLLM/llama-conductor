...
class SessionState:
    ...
    ctc_current_prompt_chars: int = 0
    ctc_current_prompt_pressure_pct: float = 0.0
    ctc_current_prompt_ctx_size: int = 0
    ctc_current_prompt_turn: int = 0
    last_web_results: List[Dict[str, Any]] = field(default_factory=list)
    last_web_results_load_id: str = ""
    last_web_facts_block: str = ""
    last_web_facts_turn: int = 0
    last_web_assistant_source: str = ""
    ...
    last_flush_message_index: int = 0
    ...
    turn_web_evidence_injected: bool = False
    ...
    # Web evidence snapshotting: prior-turn state is consumed during the next turn.
    last_turn_web_evidence_injected: bool = False
    prior_turn_web_evidence_injected: bool = False
