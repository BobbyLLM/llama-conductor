...
def command_registry() -> Dict[str, CommandMeta]:
    entries = [
        ...
        CommandMeta("codex", ("codex",), ("llama_conductor/codex_update.py available",), ("runs codex rebuild/doctor/lint/clean maintenance",), ">>codex rebuild|doctor|lint|clean"),
        ...
        CommandMeta("serious", ("serious",), ("none",), ("serious_sticky=true, all_other_sticky=false",), ">>serious"),
        CommandMeta("serious_off", ("serious off",), ("none",), ("serious_sticky=false",), ">>serious off"),
        ...
        CommandMeta("default", ("default",), ("none",), ("default_mode=<mode>, flush-persistent",), ">>default <serious|raw|fun|fun_rewrite|off>"),
    ]
